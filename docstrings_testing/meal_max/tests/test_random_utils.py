...
RANDOM_NUMBER = 0.42  # Ex: random num returned by random.org
...
def test_get_random(mock_random_org):
    """test retrieving a random float numb from random.org."""
    result = get_random()
...
def test_get_random_timeout(mocker):
    """simulate a timeout when requesting random.org."""
